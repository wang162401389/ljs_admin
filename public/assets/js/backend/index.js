define(['jquery', 'bootstrap', 'backend', 'addtabs', 'adminlte', 'form'], function ($, undefined, Backend, undefined, AdminLTE, Form) {
    var Controller = {
        index: function () {
        	//在切换选项卡的时候刷新页面中的表格
//        	$(document.body).on('click', '[addtabs]', function (e) {
//                var iframe = $("#con_" + $(this).attr("addtabs") + " iframe");
//                if (iframe.size() > 0) {
//                    if (typeof iframe.get(0).contentWindow.$ !== 'undefined') {
//                        iframe.get(0).contentWindow.$(".bootstrap-table .toolbar .btn-refresh").trigger("click");
//                    }
//                }
//            });

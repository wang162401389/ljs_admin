define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'borrow/firstfail/index',
                    add_url: 'borrow/firstfail/add',
                    edit_url: '',
                    del_url: '',
                    multi_url: 'borrow/firstfail/multi',
                    table: 'AppBorrowInfo',
                }
            });
            ...
            table.on('post-common-search.bs.table', function (event, table) {
                ...
                $("input[name='firstverify.username']", form).addClass("selectpage").data("source", "auth/admin/index").data("primaryKey", "username").data("field", "username").data("orderBy", "id desc");
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'firstVerifyTime', title: __('Firstverifytime'), operate:'RANGE', addclass:'datetimerange', sortable: true},
                        {field: 'firstVerfiyRemarks', title: __('firstVerfiyRemarks'), operate:false},
                        {field: 'firstverify.username', title: __('firstVerfiyId')},
